...
public class DbMiscTest extends DbHsqldbTestCase {
	...
	public void testBig() throws Exception {
		...
		executeUpdate(session, "drop table GIRLS if exists");
		...
		assertEquals(1, executeUpdate(session, "insert into GIRLS values(1, 'Anna', 'seduction')"));
		assertEquals(1, query.executeCount());
		assertEquals(1, executeUpdate(session, "insert into GIRLS values(2, 'Sandra', 'spying')"));
		assertEquals(2, query.executeCount());
		assertEquals(1, executeUpdate(session, "insert into GIRLS values(3, 'Monica', 'hacking')"));
