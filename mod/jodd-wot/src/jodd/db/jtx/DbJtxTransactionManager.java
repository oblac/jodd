...
public class DbJtxTransactionManager extends JtxTransactionManager {
	...
	/**
	 * Creates db jtx manager and registers provided {@link jodd.db.jtx.DbJtxResourceManager}.
	 */
	...
	/**
	 * Creates db jtx manager and registeres new {@link jodd.db.jtx.DbJtxResourceManager}.
	 */
